...
public class AuthAppController {
    ...
    public AuthAppController(UserServiceImpl userService, RefreshTokenServiceImpl refreshTokenService) {
        this.userService = userService;
        this.refreshTokenService = refreshTokenService;
    }
    @PostMapping("/signup")
    public ResponseEntity<?> registerUser(@Valid @RequestBody UserDto signUpRequest) {
        logger.info("Start App signup  ");
        ...
        logger.info("Finish App signup  ");
        return ResponseEntity.ok(new MessageResponse("User registered successfully!"));
    }
    @PostMapping("/signin")
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {

        logger.info("Start App signin  ");
        ...
        String tokenJwt = jwtUtils.generateTokenFromUsername(userDetails.getUsername());
        ...
        RefreshToken refreshToken = refreshTokenService.createAppRefreshToken(userDetails.getId() );

         logger.info("Finish App signin  ");
        return ResponseEntity.ok()
                .body(new JwtResponse(tokenJwt,  refreshToken.getToken(), Date.from(refreshToken.getExpiryDate())));
    }

    @PostMapping("/signout")
    public ResponseEntity<?> logoutUser() {
        logger.info("Start App signout  ");
        ...
        logger.info("Finish App signout  ");
        return ResponseEntity.ok()
    ...
    public ResponseEntity<?> refreshtoken(HttpServletRequest request) {
        logger.info("Start App Refreshtoken");
        ...
        logger.info("Finish App Refreshtoken");
